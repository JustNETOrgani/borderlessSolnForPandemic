                    ...
                    <div class="grid-content bg-purple-dark">
                        <el-form
                            ...
                            <fieldset>
                                ...
                                <br>
                                <el-form-item>
                                    <el-button type="danger" :loading="registCountryBtnLoadState" @click="submitForm('tcRegistForm')">Revoke TC</el-button>
              ...
              if (valid) {
                ...
                try {
                  ...
                  const txParams = {
                    ...
                    to: contractAddress,
                    data: countrySC.methods.registerTC(data.tcName, data.addrOfTC, data.revokeReason).encodeABI()
                  }
