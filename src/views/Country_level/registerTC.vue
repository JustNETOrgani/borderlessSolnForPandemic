<template>
    <div class="pageContainer">
        ...
        <div class="formArea">
            <h2>TC registration</h2>
            <i><p>Enables a TC perform testing/vaccination for global use</p></i>
            <el-row>
                <el-col :span="3">
                    ...
                    <div class="grid-content bg-purple-dark">
                        <el-form
                            ...
                            <fieldset>
                                ...
                                <br>
                                <el-form-item>
                                    <el-button type="primary" :loading="registCountryBtnLoadState" @click="submitForm('tcRegistForm')">Register TC</el-button>
              ...
              if (valid) {
                ...
                try {
                  ...
                  const txParams = {
                    ...
                    to: contractAddress,
                    data: countrySC.methods.registerTC(data.tcName, data.addrOfTC).encodeABI()
                  }
