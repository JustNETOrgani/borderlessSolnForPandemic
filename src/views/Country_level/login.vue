...
export default {
  ...
  data () {
    return {
      ...
      // Background image.
      image: { backgroundImage: 'url(https://user-images.githubusercontent.com/44321289/126899606-29af81b1-65ac-4492-a70a-813eed16f359.jpg)' }
    }
  },
  components: {
  },
