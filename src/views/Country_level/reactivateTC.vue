<template>
    <div class="pageContainer">
        ...
        <div class="formArea">
            <h2>Reactivate TC</h2>
            <i><p>Enables TC to perform tests/vaccination for global use</p></i>
            <el-row>
                <el-col :span="3">
                        ...
                        <el-form
                            ...
                            <fieldset>
                                ...
                                <el-form-item label="Reason" prop="reactivateReason">
                                    <el-input v-model="tcRegistForm.reactivateReason" placeholder="Please input reason for reactivation."></el-input>
                                </el-form-item>
