    ...
    <div class="pageContainer">
        ...
        <div class="formArea">
          <el-row>
            ...
            <h2>Country revocation</h2>
            <i><p>Disables a country's testing/vaccination centers for global use.</p></i>
            <el-row>
                    ...
                    <div class="grid-content bg-purple-dark">
                        <el-form
                            ...
                            <el-form-item label="Reason" prop="revokeReason">
                                <el-input v-model="countryRegistForm.revokeReason" placeholder="Please input reason for revocation."></el-input>
                            </el-form-item>
                            ...
                            <el-form-item>
                                <el-button type="danger" :loading="registCountryBtnLoadState" @click="submitForm('countryRegistForm')">Revoke</el-button>
            ...
            this.$refs[formName].validate(valid => {
              ...
              if (valid) {
                ...
                var data = {
                  ...
                  revokeReason: this.countryRegistForm.revokeReason
                }
                ...
                try {
                  ...
                  const txParams = {
                    ...
                    to: contractAddress,
                    data: WHOsmartContract.methods.revokeCountry(data.countryName, data.scAddrOfCountry, data.revokeReason).encodeABI()
                  }
                  this.sendTnx(txParams).then(tnxReceipt => {
                    ...
                    this.$alert('Transaction hash : ' + tnxReceipt, 'Revocation success', {
                      confirmButtonText: 'OK',
                      callback: action => {
                        this.$message({
                          type: 'info',
                          message: 'Country successfully revoked.'
                        })
                      }
                    })
